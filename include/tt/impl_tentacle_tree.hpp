...
std::size_t computeMortonCode(const PointT &point, const std::array<PointCoordinateTypeT<PointT>, 3> &center) {
...
template <Point3d PointT, ForwardPoint3dIterator BeginIt,
          ForwardPoint3dIterator EndIt>
std::array<std::vector<PointT>, 8> distributePointsToOctants(BeginIt begin, EndIt end,
