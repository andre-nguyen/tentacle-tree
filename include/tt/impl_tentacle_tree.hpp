...
template <Point3d PointT, typename Allocator>
bool isBoxInNode(const BoundingBox<typename Node<PointT, Allocator>::CoordT> &box,
                 const Node<PointT, Allocator> &node) {
...
template <Point3d PointT, typename Allocator>
bool isNodeInBox(const Node<PointT, Allocator> &node,
                 const BoundingBox<typename Node<PointT, Allocator>::CoordT> &box) {
...
template <Point3d PointT, typename Allocator, ForwardPoint3dIterator BeginIt,
          ForwardPoint3dIterator EndIt>
...
void splitAndInsertPoints(BeginIt begin, EndIt end, Node<PointT, Allocator> &node,
    ...
    using CoordT = PointCoordinateTypeT<PointT>;
    auto octant_points =
        impl::distributePointsToOctants<PointT, Allocator>(begin, end, node.center);
...
template <std::random_access_iterator BeginIt, std::random_access_iterator EndIt, Point3d PointT,
          typename Allocator>
void insertIntoLeaf(BeginIt begin, EndIt end, Node<PointT, Allocator> &node,
                    const std::size_t bucket_size, std::size_t num_points) {
    // TODO: downsampling
...
template <Point3d PointT, typename Allocator>
bool isNodeSmallestPossible(const Node<PointT, Allocator> &node,
                            PointCoordinateTypeT<PointT> min_extent) {
...
template <Point3d PointT, typename Allocator>
void collectLeafNodes(std::vector<const Node<PointT, Allocator> *> &leaves,
                      const Node<PointT, Allocator> &node) {
    bool is_leaf = true;
...
collectLeafPoints(std::vector<const Node<PointT, Allocator> *> &leaves) {
...
PointCoordinateTypeT<PointT> nodeToPointDistance(const Node<PointT, Allocator> &node,
                                                 const PointT &point) {
    // Section II. C
...
template <Point3d PointT, typename Allocator>
TentacleTree<PointT, Allocator>::TentacleTree(std::size_t bucket_size, CoordT min_extent,
...
template <std::random_access_iterator BeginIt, std::random_access_iterator EndIt>
std::unique_ptr<Node<PointT, Allocator>>
TentacleTree<PointT, Allocator>::createNode(const std::array<CoordT, 3> &center, CoordT half_extent,
...
template <Point3d PointT, typename Allocator>
std::unique_ptr<Node<PointT, Allocator>>
TentacleTree<PointT, Allocator>::boxDelete(const BoundingBox<CoordT> &box,
...
template <Point3d PointT, typename Allocator>
TentacleTree<PointT, Allocator>::SearchResult
TentacleTree<PointT, Allocator>::knnSearch(const PointT &query_point, std::size_t k) {
